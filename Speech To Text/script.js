...
const languages = [
  ...
  class LanguageSelector extends HTMLElement {
    constructor() {
        ...
        select.setAttribute('name', 'input-language');
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    let inputLanguage = document.querySelector('language-selector').shadowRoot.querySelector('#language');
        ...
        try {
            ...
            recognition.onresult = event => {
                ...
                if (event.results[0].isFinal) {
                    ...
                    document.querySelector('.interim').textContent = ' ' + speechResult;
                }
